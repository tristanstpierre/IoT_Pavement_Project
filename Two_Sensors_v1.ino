...
void loop() {
  ...
  if (frequency1 > 1.5) {
    ...
    String dataToSend = "AT+SEND=0," + String(freq1String.length()) + "," + freq1String;
  ...
  if (frequency2 > 1.5) {
    ...
    String dataToSend = "AT+SEND=0," + String(freq2String.length()) + "," + freq2String;
    Serial.println(dataToSend);
    lorawanSerial.println(dataToSend);
