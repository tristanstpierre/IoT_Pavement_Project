...
#include "arduinoFFT.h" // Include the Arduino FFT library
...
{   
  ...
  samplingPeriod = round(1000000 * (1.0 / SAMPLING_FREQ)) - 1;
}
...
void AccelerationData() {
  ...
  Serial.print("Vibration Frequency: ");  // print ", Vibration Frequency: " to the serial monitor
